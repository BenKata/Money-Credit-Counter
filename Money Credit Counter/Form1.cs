    ...
    public partial class Form1 : Form
    {
        ...
        private void btn_2p_Click(object sender, EventArgs e)
        {
            ...
            else // Otherwise
            {
                ...
                Total_Pound += 0.02; // adds 2p to the total pound value 
        ...
        private void btn_5p_Click(object sender, EventArgs e)
        {
            ...
            else // Otherwise
            {
                ...
                Total_Pound += 0.05; // adds 5p to the total pound value 
        ...
        private void btn_10p_Click(object sender, EventArgs e)
        {
            ...
            else // Otherwise
            {
                ...
                Total_Pound += 0.10; // adds 10p to the total pound value 
        ...
        private void btn_20p_Click(object sender, EventArgs e)
        {
            ...
            else // Otherwise
            {
                ...
                Total_Pound += 0.20; // adds 20p to the total pound value 
        ...
        private void btn_50p_Click(object sender, EventArgs e)
        {
            ...
            else // Otherwise
            {
                ...
                Total_Pound += 0.50; // adds 50p to the total pound value 
        ...
        private void btn_1pound_Click(object sender, EventArgs e)
        {
            ...
            else // Otherwise
            {
                ...
                Total_Pound += 1.00; // adds £1 to the total pound value 
        ...
        private void btn_2pound_Click(object sender, EventArgs e)
        {
            ...
            else // Otherwise
            {
                ...
                Total_Pound += 2.00; // adds £2 to the total pound value 
